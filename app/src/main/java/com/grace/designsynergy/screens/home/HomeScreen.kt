...
import com.grace.designsynergy.navigation.ROUTE_POPUPMENU
import com.grace.designsynergy.navigation.ROUTE_PROFESSIONALS
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Card(
            ...
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                Button(onClick = {
                    navController.navigate(ROUTE_POPUPMENU)
                },
